...
-- ==========================================================================
-- 16. email_templates  — editable subject/body keyed by template_key.
--     Body strings use {{placeholders}} which the Mailer expands.
-- ==========================================================================
...
VALUES
    ...
    -- Mail (SMTP)
    ('mail_smtp_host',    'smtp.example.com',            'string', 'SMTP server host.',                1),
    ('mail_smtp_port',    '587',                         'int',    'SMTP server port.',                1),
    ('mail_smtp_user',    '',                            'string', 'SMTP username.',                   1),
    ('mail_smtp_pass',    '',                            'string', 'SMTP password (plain — restrict).',1),
    ('mail_smtp_secure',  'tls',                         'string', 'tls | ssl | (blank for none).',    1),
    ('mail_from_email',   'no-reply@olympicsrun2026.in', 'string', 'Default From: address.',           1),
    ('mail_from_name',    'Olympics Run 2026',           'string', 'Default From: name.',              1),
    ('mail_auto_send_on_assign', 'false',                'bool',   'Auto-send credentials on assign.', 1);

-- Default email template for school credentials.
